...
export function WorkAreaEditor() {
  ...
  return (
    <>
      ...
      <p className="note">
        面の端から何ミリ内側までなら穴を開けられるかの登録です。
        <b>日東工業 RA形は自動で入ります</b>——DXF 取り込みや型式の選択で型式名が決まった
        時点で、シリーズの値が当たります。この表はその<b>確認と手直し用</b>です。
        自動で入らないシリーズだけ、型式ごとに1回手で登録します。
      ...
      <p className="note warn">
        ...
        図から読み取るのではなく<b>型式名でシリーズを見分けて</b>数値を当てています。
        当てた値は正解の保証ではないので、納入仕様書と突き合わせてください。
      </p>

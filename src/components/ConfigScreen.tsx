...
export function ConfigScreen() {
  ...
  return (
    <div className="screen">
      ...
      <p className="note">
        <b>ブラウザの中身が本体です。バックアップは書くだけで、ふだん読み込むことはありません。</b>
        部品表・設定・My部品・完了案件・作業中案件はすべてこのブラウザ（IndexedDB）に残り、
        開き直せばそのまま出ます。読み込むのは、ブラウザのデータが消えていたとき
        （バックアップ先が<b>この HTML と同じフォルダ</b>なら開くだけで写しから自動で戻ります）と、
        別の PC へ移すとき・壊れたときに下の「一括読み込み」を人が押したときだけです。
        バックアップ先には最新（panel-studio-backup.json）・1つ前（.prev.json）のほかに、
        <b>history フォルダに日付つきの控えを 30 日ぶん</b>残します。
      </p>

...
- **隣へ持っていくと並びます。** Shift＋ドラッグで独立レールの機器の近く（25mm 以内）へ
  運ぶと、**レールの高さに揃えて、ストッパのぶんだけ空けた位置に吸い付きます**
  （独立レールどうしなら機器の間が 5＋5＝10mm、レールは端どうしがぴったり接します）。
  1mm ずつ目分量で寄せる作業をなくすためです。吸い付いた先がダクトに掛かるときは
  吸着しません
